...
from packages.valory.skills.transaction_settlement_abci.rounds import (
    PeriodState,
    TransactionSubmissionAbciApp, TransactionRounds,
)
...
class TransactionBehaviours:
    transaction_rounds: Type[TransactionRounds] = TransactionRounds

    def __init_subclass__(cls, **kwargs):
        for name, member_type in inspect.getmembers(cls):
            if inspect.isclass(member_type) and issubclass(member_type, BaseState):
                for round_name, round_type in inspect.getmembers(cls.transaction_rounds):
                    if inspect.isclass(member_type) and \
                            issubclass(round_type, member_type.matching_round):
                        subclass = type(name, (member_type,), {"matching_round": round_type})  # subclass the inner class
    ...
    class RandomnessTransactionSubmissionBehaviour(RandomnessBehaviour):
        ...
        matching_round = TransactionRounds.RandomnessTransactionSubmissionRound
    ...
    class SelectKeeperTransactionSubmissionBehaviourA(  # pylint: disable=too-many-ancestors
        ...
        matching_round = TransactionRounds.SelectKeeperTransactionSubmissionRoundA
    ...
    class SelectKeeperTransactionSubmissionBehaviourB(  # pylint: disable=too-many-ancestors
        ...
        matching_round = TransactionRounds.SelectKeeperTransactionSubmissionRoundB
        payload_class = SelectKeeperPayload
    ...
    class SelectKeeperTransactionSubmissionBehaviourBAfterTimeout(  # pylint: disable=too-many-ancestors
        ...
        matching_round = TransactionRounds.SelectKeeperTransactionSubmissionRoundBAfterTimeout
        payload_class = SelectKeeperPayload
    ...
    class ValidateTransactionBehaviour(TransactionSettlementBaseState):
        ...
        matching_round = TransactionRounds.ValidateTransactionRound
    ...
    class CheckTransactionHistoryBehaviour(TransactionSettlementBaseState):
        ...
        matching_round = TransactionRounds.CheckTransactionHistoryRound
    ...
    class CheckLateTxHashesBehaviour(  # pylint: disable=too-many-ancestors
        ...
        matching_round = TransactionRounds.CheckLateTxHashesRound
    ...
    class SynchronizeLateMessagesBehaviour(TransactionSettlementBaseState):
        ...
        matching_round = TransactionRounds.SynchronizeLateMessagesRound
    ...
    class SignatureBehaviour(TransactionSettlementBaseState):
        ...
        state_id = "sign"
        matching_round = TransactionRounds.CollectSignatureRound
    ...
    class FinalizeBehaviour(TransactionSettlementBaseState):
        ...
        state_id = "finalize"
        matching_round = TransactionRounds.FinalizationRound
    ...
    class ResetBehaviour(TransactionSettlementBaseState):
        ...
        matching_round = TransactionRounds.ResetRound
        state_id = "reset"
...
class TransactionSettlementRoundBehaviour(AbstractRoundBehaviour):
    ...
    behaviours: Type[TransactionBehaviours] = TransactionBehaviours
    initial_state_cls = TransactionBehaviours.RandomnessTransactionSubmissionBehaviour
    abci_app_cls = TransactionSubmissionAbciApp
    behaviour_states: Set[Type[BaseState]] = {
        TransactionBehaviours.RandomnessTransactionSubmissionBehaviour,
        TransactionBehaviours.SelectKeeperTransactionSubmissionBehaviourA,
        TransactionBehaviours.SelectKeeperTransactionSubmissionBehaviourB,
        TransactionBehaviours.SelectKeeperTransactionSubmissionBehaviourBAfterTimeout,
        TransactionBehaviours.ValidateTransactionBehaviour,
        TransactionBehaviours.CheckTransactionHistoryBehaviour,
        TransactionBehaviours.SignatureBehaviour,
        TransactionBehaviours.FinalizeBehaviour,
        TransactionBehaviours.SynchronizeLateMessagesBehaviour,
        TransactionBehaviours.CheckLateTxHashesBehaviour,
        TransactionBehaviours.ResetBehaviour,
    }

    def __init_subclass__(cls, **kwargs):
        cls.initial_state_cls = cls.behaviours.RandomnessTransactionSubmissionBehaviour
        cls.behaviour_states: Set[Type[BaseState]] = {
            cls.behaviours.RandomnessTransactionSubmissionBehaviour,
            cls.behaviours.SelectKeeperTransactionSubmissionBehaviourA,
            cls.behaviours.SelectKeeperTransactionSubmissionBehaviourB,
            cls.behaviours.SelectKeeperTransactionSubmissionBehaviourBAfterTimeout,
            cls.behaviours.ValidateTransactionBehaviour,
            cls.behaviours.CheckTransactionHistoryBehaviour,
            cls.behaviours.SignatureBehaviour,
            cls.behaviours.FinalizeBehaviour,
            cls.behaviours.SynchronizeLateMessagesBehaviour,
            cls.behaviours.CheckLateTxHashesBehaviour,
            cls.behaviours.ResetBehaviour,
        }
