...
class TokenVaultContract(Contract):
    ...
    def kick_curator(
        ...
        raw_tx = token_vault_contract.functions.kickCurator(curator_address).buildTransaction(tx_parameters)
    ...
    def transfer_erc20(
        ...
        raw_tx = token_vault_contract.functions.transfer(receiver_address, amount).buildTransaction(tx_parameters)
