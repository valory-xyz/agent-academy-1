...
from packages.elcollectooorr.skills.elcollectooorr_abci.dialogues import (
    HttpDialogue,
    HttpDialogues,
)
...
class HttpHandler(BaseHttpHandler):
    ...
    def setup(self) -> None:
        ...
        self.handler_url_regex = rf"{hostname_regex}\/.*"   # pylint: disable=attribute-defined-outside-init
    ...
    def _handle_get_health(
        ...
        if round_sequence._last_round_transition_timestamp:  # pylint: disable=protected-access
        ...
        if round_sequence._abci_app:  # pylint: disable=protected-access
            current_round = round_sequence._abci_app.current_round.round_id  # pylint: disable=protected-access
            previous_rounds = [
                r.round_id for r in round_sequence._abci_app._previous_rounds[-10:]  # pylint: disable=protected-access
            ]
