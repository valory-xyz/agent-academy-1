...
class TestBasketFactory(BaseGanacheContractTest):
    ...
    def test_create_basket(self):
        ...
        tx = self.contract.create_basket(
            ...
            factory_contract_address=self.contract_address,
        ...
        basket_info = self.contract.get_basket_address(self.ledger_api, self.contract_address, tx_hash)
        ...
        assert basket_info["creator_address"] == sender.address, "creator_address doesnt match signer"
